...
import { assignTask } from '../../service/api/assignmentApi';
  ...
  const TaskModal = ({open, closeModal,item}) => {
        ...
        <View style={styles.modalBackground}>
          <View style={styles.innerModal}>
                  ...
                  <View style={styles.innerModalMain}>
                    <View style={styles.innerModalCenterView}>
                      <View style={styles.innerTextView}>
                        <Text style={styles.innerStudentText}>{item.show_name}</Text>
                      </View>
                      <CustomCheckBox
                      item={item}
            ...
            <View style={styles.Button}>
              ...
              <TouchableOpacity onPress={handelAssignTask} style={styles.confirmButton}>
